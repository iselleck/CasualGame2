...
public class Demo : MonoBehaviour 
{
	...
	public float RECIVE_TWEET_X;
	public float RECIVE_TWEET_Y;
	public float RECIVE_TWEET_WIDTH;
	public float RECIVE_TWEET_HEIGHT;

	public float BRECIVE_TWEET_X;
	public float BRECIVE_TWEET_Y;
	public float BRECIVE_TWEET_WIDTH;
	public float BRECIVE_TWEET_HEIGHT;
	...
	string m_recieve ="Enter a account to pull from";
    ...
    void OnGUI()
    {
		...
		//recieve tweet input
		rect.x = Screen.width * RECIVE_TWEET_X;
		rect.y = Screen.height * RECIVE_TWEET_Y;
		rect.width = Screen.width * RECIVE_TWEET_WIDTH;
		rect.height = Screen.height * RECIVE_TWEET_HEIGHT;

		m_recieve = GUI.TextField(rect, m_recieve);

		rect.x = Screen.width * BRECIVE_TWEET_X;
		rect.y = Screen.height * BRECIVE_TWEET_Y;
